"""ValidationProcessor for log event structure and content validation."""
...
class ValidationProcessor(Processor):
    ...
    def validate_config(self) -> None:
        ...
        if not self.required_fields or len(self.required_fields) == 0:
